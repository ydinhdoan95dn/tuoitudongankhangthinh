...
// PHP 8.0+: get_magic_quotes_gpc() removed, magic quotes disabled by default since PHP 5.4
...
// PHP 8.0+: mysql_* functions removed, use MySQLi instead
if ($phpThumb->config_mysql_query) {
	if ($cid = @mysqli_connect($phpThumb->config_mysql_hostname, $phpThumb->config_mysql_username, $phpThumb->config_mysql_password, $phpThumb->config_mysql_database)) {
