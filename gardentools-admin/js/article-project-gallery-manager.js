/**
 * ARTICLE PROJECT GALLERY MANAGER
 * Quản lý thư viện ảnh dự án BĐS (bảng dxmt_article_project)
 *
 * @version 2.0
 * @author DXMT
 */
...
(function() {
    ...
    const API_URL = ADMIN_PATH + 'ajax_article_project_gallery.php';

    class ArticleProjectGalleryManager {
        constructor(container, options = {}) {
            ...
            if (!this.container) {
                console.error('[APGM] Container not found');
                return;
            }
        ...
        async init() {
            console.log('[APGM] Initializing...', this.options);
        ...
        async initTables() {
            try {
                ...
                if (response.success) {
                    console.log('[APGM] Tables ready');
                }
            } catch (e) {
                console.error('[APGM] Init tables error:', e);
            }
        }
        ...
        async loadData() {
            ...
            try {
                ...
                console.error('[APGM] Load data error:', e);
        ...
        async loadTabDescription() {
            const response = await this.api('get_tab', {
                article_project_id: this.options.articleProjectId,
        ...
        async loadImages(categoryId) {
            ...
            try {
                ...
                console.error('[APGM] Load images error:', e);
        ...
        async saveNewCategory() {
            ...
            try {
                ...
                console.error('[APGM] Add category error:', e);
        ...
        async finishEditCategory(categoryId) {
            ...
            try {
                ...
                console.error('[APGM] Edit category error:', e);
        ...
        async deleteCategory(categoryId) {
            ...
            try {
                ...
                console.error('[APGM] Delete category error:', e);
                catElement?.classList.remove('pgm-category-deleting');
        ...
        async uploadPendingQueue() {
            ...
            formData.append('article_project_id', this.options.articleProjectId);
            ...
            try {
                ...
                console.error('[APGM] Upload error:', e);
                this.hideFullscreenLoading();
        ...
        async saveImageTitle() {
            ...
            try {
                ...
                console.error('[APGM] Save image title error:', e);
                this.showToast('Lỗi lưu tiêu đề', 'error');
            }
        }

        async deleteImage(imageId, skipConfirm = false) {
            console.log('[APGM] deleteImage called with imageId:', imageId);
            ...
            try {
                ...
                console.error('[APGM] Delete image error:', e);
        ...
        async saveTabDescription() {
            ...
            try {
                ...
                console.error('[APGM] Save tab description error:', e);
        ...
        setArticleProjectId(articleProjectId) {
            this.options.articleProjectId = articleProjectId;
        }

        async finalizeArticle(tempId, articleProjectId) {
            return this.api('finalize_article', {
                temp_id: tempId,
                article_project_id: articleProjectId
            });
        }
    ...
    // Export to global
    window.ArticleProjectGalleryManager = ArticleProjectGalleryManager;
