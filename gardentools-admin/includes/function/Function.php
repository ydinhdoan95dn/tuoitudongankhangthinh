...
//
// Autoload function - Compatible with PHP 8.x
...
function dashboardCoreAdmin() {
	...
	if(in_array($tth, $corePrivilegeSlug)) return;
	...
	// Kiểm tra quyền cha
	if(isset($parentMapping[$tth]) && in_array($parentMapping[$tth], $corePrivilegeSlug)) return;
