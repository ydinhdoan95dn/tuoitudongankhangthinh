...
<div class="row">
	<ol class="breadcrumb">
		...
		<a class="btn-add-new" href="?<?=TTH_PATH?>=core_role_add">Thêm nhóm</a>
	</ol>
</div>
<!-- /.row -->
<?=dashboardCoreAdmin(); ?>
	...
	<div class="col-lg-12">
		<div class="panel panel-default panel-no-border">
			<div class="table-responsive">
				<form action="?<?=TTH_PATH?>=core_role" method="post" id="deleteArt">
						...
						foreach($rows as $row) {
							...
							<tr>
								...
								<td class="details-control" align="center">
									<div class="checkbox">
										<a href="?<?=TTH_PATH?>=core_role_edit&id=<?=$row['role_id']?>"><img data-toggle="tooltip" data-placement="top" title="Chỉnh sửa" src="images/edit.png"></a> &nbsp;
										<label class="checkbox-inline">
											<input type="checkbox" data-toggle="tooltip" data-placement="top" title="Xóa" class="checkboxArt" name="idDel[]" value="<?=$row['role_id']?>">
										</label>&nbsp;&nbsp;
					...
					<div class="row">
						<div class="col-sm-6"><?=showPageNavigation($page, $totalpages, '?'.TTH_PATH.'=core_role&page=')?></div>
