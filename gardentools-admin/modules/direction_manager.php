...
<div class="row">
	<ol class="breadcrumb">
		...
		<a class="btn-add-new" href="?<?=TTH_PATH?>=direction_add">Thêm mục</a>
	...
	<div class="col-lg-12">
		<div class="panel panel-default panel-no-border">
			<div class="table-responsive">
				<form action="?<?=TTH_PATH?>=direction_manager" method="post" id="deleteArt">
						...
						foreach($rows as $row) {
							...
							<tr>
								...
								if(in_array("direction_edit",$corePrivilegeSlug)) {
									?>
									<td align="center">
										<?=showSort("sort_".$row["direction_id"]."", $countList,$row["sort"], "80%", 0, $row["direction_id"] ,'direction', 1);?>
									</td>
									<td align="center">
										<?=($row["is_active"]+0==0)?
								...
								<?php
									...
									?>
									<td align="center">
										<?=showSort("sort_".$row["direction_id"]."", $countList,$row["sort"], "80%", 0, $row["direction_id"] ,'direction', 0);?>
									</td>
									<td align="center">
										<?=($row["is_active"]+0==0)?
								...
								<td class="details-control" align="center">
									<div class="checkbox">
										<a href="?<?=TTH_PATH?>=direction_edit&id=<?=$row['direction_id']?>"><img data-toggle="tooltip" data-placement="top" title="Chỉnh sửa" src="images/edit.png"></a> &nbsp;
										<label class="checkbox-inline">
											<input type="checkbox" data-toggle="tooltip" data-placement="top" title="Xóa" class="checkboxArt" name="idDel[]" value="<?=$row['direction_id']?>">
										</label>
									</div>
								</td>
							</tr>
					...
					<div class="row">
						<div class="col-sm-6"><?=showPageNavigation($page, $totalpages,'?'.TTH_PATH.'=direction_manager&page=')?></div>
						<div class="col-sm-6" align="right" style="padding: 7px 0;">
							...
							<input type="button" class="btn btn-primary btn-xs  <?=in_array("direction_del",$corePrivilegeSlug)? "confirmManager" : "alertManager"?> " value="Xóa mục" name="deleteArt">
						</div>
					</div>
				</form>
			</div>
